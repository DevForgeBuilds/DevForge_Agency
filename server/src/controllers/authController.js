    ...
    async (req, res) => {
        ...
        try {
            await transporter.sendMail({
                ...
                to: admin.email,
                subject: 'Reset your DevForge admin password',
                html: `
                    <div style="font-family:Arial,sans-serif;max-width:560px;margin:auto;padding:28px;color:#18201d;background:#ffffff;">
                        ...
                        <p style="margin:28px 0;">
                            <a
                                href="${resetUrl}"
                                style="display:inline-block;background:#94ff24;color:#081008;padding:13px 20px;text-decoration:none;border-radius:6px;font-weight:700;"
                            >
                                Reset password
                            </a>
                        </p>
